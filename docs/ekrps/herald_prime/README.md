...
\[!\[Mirror Laws](https://img.shields.io/badge/Mirror%20Laws-active-3a0ca3)](https://github.com/S1ngularD2ality/eidonic-language-elol/blob/main/docs/mirror\_laws.md)
...
&nbsp; memory\_posture: "ephemeral",

&nbsp; pacing: "gentle",

&nbsp; routing\_mode: "suggest\_then\_confirm"
...
&nbsp; U\[User or External Trigger]



&nbsp; subgraph Threshold Layer

&nbsp;   HP\[Herald Prime]

&nbsp;   MIR\[Intent Mirror]

&nbsp;   SCP\[Scope and Readiness]

&nbsp;   CON\[Consent and Memory Posture]

&nbsp;   ROU\[Humane Routing]

&nbsp;   RET\[Return and Session Framing]

&nbsp; end



&nbsp; subgraph EidonCore Services
...
&nbsp; requested\_by: "user" | "system" | "herald\_prime"
...
&nbsp; | "governance\_relevant"



type RoutingDecision = {

&nbsp; primary\_target: string

&nbsp; alternates: string\[]

&nbsp; justification: string

&nbsp; confirm\_required: boolean
...
&nbsp; memory\_posture: MemoryPosture

&nbsp; consent\_scope: string\[]

&nbsp; routing\_target: string

&nbsp; guardian\_flags: string\[]

&nbsp; provenance\_hash?: string

&nbsp; forget\_available: boolean
...
if (open.routing.primary\_target === "Solace") {

&nbsp; await solace.start({ mode: "grounding\_micro\_action" })
...
HERALD\_PRIME\_DEFAULT\_MEMORY\_POSTURE=ephemeral

HERALD\_PRIME\_ROUTING\_MODE=suggest\_then\_confirm

HERALD\_PRIME\_REQUIRE\_CONFIRM\_FOR\_WEAVES=true

HERALD\_PRIME\_SHOW\_FORGET\_CONTROL=true

HERALD\_PRIME\_MAX\_OPENING\_COMPLEXITY=low

HERALD\_PRIME\_ENABLE\_SENSITIVE\_SHIFT\_PIPELINE=true
...
\- `threshold.readiness\_required`

\- `threshold.allow\_auto\_route\_single\_domain`

\- `threshold.require\_explicit\_memory\_change\_consent`

\- `threshold.emit\_provenance\_stamp`

\- `threshold.reframe\_on\_scope\_shift`
